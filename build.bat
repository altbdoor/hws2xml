...
set mcs_path=C:\Program Files (x86)\Mono\bin\mcs.bat
...
call "%mcs_path%" -out:hws2xml.exe -r:System -r:System.Drawing -r:System.Xml.Linq Main.cs OpenTK.cs TiltedEngine.cs
